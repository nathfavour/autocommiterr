...
program
  ...
  .action(async (options) => {
    try {
      ...
      console.log('🔒 Ensuring .gitignore safety...');
      ...
      if (!message) {
        ...
        if (!apiKey) {
          console.log('⚠️  No API key found. Using default message.');
          ...
          try {
            ...
            try {
              ...
              if (aiResult && aiResult.trim().length > 0) {
                ...
                console.log(`✓ Used ${selectedModel} to generate the message.`);
              }
            } catch (apiErr) {
              console.error('⚠️  API-based generation failed:', (apiErr as Error)?.message);
              message = 'chore: automated commit generated by Autocommiter';
            }
          } catch (e) {
            console.error('⚠️  Failed to generate message:', (e as Error)?.message);
            message = 'chore: automated commit generated by Autocommiter';
          }
        }
      }
